...
/**
 * Helper class for creating strongly-typed OpenClaw chat options for the OpenAI-compatible /v1/chat/completions endpoint.
 *
 ...
 * @since 0.8.0
 * @see <a href=
 * "https://docs.openclaw.ai/gateway/openai-http-api">OpenClaw OpenAI HTTP API</a>
...
public class OpenClawChatOptions implements ToolCallingChatOptions, StructuredOutputChatOptions {
	 ...
	 * By default, the provider will detect this value for optimal performance.
	 */
	...
	// Following fields are not part of the standard OpenAI API but part of the Request.

	/**
	 * NOTE: Synthetic field not part of the official OpenAI API.
	 * Used to allow overriding the model name with prompt options.
	 * Part of Chat completion <a href="https://docs.openclaw.ai/gateway/openai-http-api#chat-tool-contract">parameters</a>.
	 */
	@JsonProperty("model")
	 ...
	 * Part of Chat completion <a href="https://docs.openclaw.ai/gateway/openai-http-api#chat-tool-contract">advanced parameters</a>.
	 */
	@JsonProperty("format")
	private Object format;

	/**
	 * Controls how long the model stays loaded. (Ollama-specific, ignored by OpenClaw Gateway.)
	 * Part of Chat completion <a href="https://docs.openclaw.ai/gateway/openai-http-api#chat-tool-contract">advanced parameters</a>.
	 */
	...
	/**
	 * Convert the {@link OpenClawChatOptions} object to a {@link Map} of key/value pairs.
